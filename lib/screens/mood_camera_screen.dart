...
class _MoodCameraScreenState extends State<MoodCameraScreen> {
  ...
  Future<void> _saveMood(String mood) async {
    ...
    if (totalEntries + 1 >= 21) {
      print("📬 21 entries collected. Sending to Python server...");
      ...
      bool sent = await sendToPythonServer(flatList);

      if (sent) {
        await prefs.remove('mood_history');
        print("✅ Cleared mood history after sending.");
      }
    } else {
